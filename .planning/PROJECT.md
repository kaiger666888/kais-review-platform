...
- [x] **SHOT-01**: Shot Card 数据模型（shot_id, project_id, narrative_context, visual_bundle, audio_bundle, audit_state, provenance） — v2.0 Phase 15-01
...
- [x] **DB-01**: PostgreSQL + TimescaleDB 替换 SQLite — 热存储 30 天滚动 — v2.0 Phase 15-01
