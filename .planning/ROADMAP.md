...
Plans:
- [ ] 22-01-PLAN.md — Merkle Root anchoring + dual-write audit recorder + tiered storage lifecycle (AUDIT-01, AUDIT-02, DB-02, DB-03)
- [ ] 22-02-PLAN.md — Multi-role authentication: Role enum, JWT role claims, require_role dependencies, role-aware token exchange (AUTH-01)
...
| 22. Audit & Compliance | v2.0 | 0/3 | Planned | - |
